...
silent only
cd ~/PapaBob/PapaBob.Presentation
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 Opcije.cs
badd +0 PocetnaStrana.cs
badd +0 Pretraga.cs
badd +0 PrikaziPorudzbinu.cs
badd +0 Stanje.cs
argglobal
silent! argdel *
$argadd Opcije.cs
$argadd PocetnaStrana.cs
$argadd Pretraga.cs
$argadd PrikaziPorudzbinu.cs
$argadd Stanje.cs
edit Opcije.cs
...
silent! normal! zE
let s:l = 39 - ((23 * winheight(0) + 18) / 37)
